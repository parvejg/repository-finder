...
w-[70%] h-[60%] bg-white rounded-xl pt-4  mt-5 text-center"
        >
          <div className="flex flex-col w-[100%] items-center h-[90%]">
            <p className=" flex  justify-around items-center gap-3 justify-center text-xl bg-red-100 mt-2 w-[80%] h-9 text-center align-center cursor-pointer rounded-xl border-solid border-2 border-black">
              Select a Language{" "}
              <span>
